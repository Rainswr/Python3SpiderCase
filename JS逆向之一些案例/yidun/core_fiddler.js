            ...
            try {
                ...
                if (c) {
                    ...
                    if (m) {
                        if ("end" !== R)
                            return;
                        var k = g || b.getEntriesByName(h && h._originUrl || i)[0];
                        if (!k)
                            return;
                        e.collect(n, T, {
                            tc: a(k.responseEnd - (k.domainLookupStart || k.connectStart), 1),
                            dc: a(k.domainLookupEnd - k.domainLookupStart, 1),
                            cc: a(k.connectEnd - k.connectStart, 1),
                            rc: a(k.responseStart - k.requestStart, 1),
                            rr: a(k.responseEnd - k.responseStart, 1),
                            url: i,
                            host: w.host,
                            https: "https" === w.protocol,
                            from: "PERF"
                        }, {}, l({}, t))
                    } else
                        e.collect(n, T, {
...
, function(e, t, n) {
    ...
    function r(e, t) {
        ...
        var c = "auto" !== a;
        return c && ("number" === s.typeOf(a) || Number(a) || "0" === a ? a += "px" : /\d+(\.\d+)?(px|rem)/.test(a) || (a = parseFloat(a, 10) || 0,
        a = a >= 0 && a <= 100 ? a + "%" : e.top)),
        {
            width: o,
            top: a,
        ...
        methods: {
            ...
            onMouseMove: function(e) {
                ...
                "dragend" !== i.status) {
                    ...
                    var gap =  [Math.round(i.dragX < 0 ? 0 : i.dragX), Math.round(i.clientY - i.startY), a.now() - i.beginTime];
                    console.log("gap is", gap);
                    this.gap_list.push(gap);
                    var f = p(u, gap + "");
            ...
            onMouseUp: function(e) {
                ...
                // console.log("xyt_gaplist is", this.gap_list);
                console.log("trace_data is", this.traceData);
                console.log("left is", this.$jigsaw.style.left);
                console.log("img_token is", i);
                this.onVerifyCaptcha({
                    data: JSON.stringify({
                        d: h(n.join(":")),
                        m: "",
            ...
            restrict: function(e, t) {
                if (e) {
                    // console.log("this. drag is", this.drag);
                    // console.log("this. dragdragX is", this.dragX);
                    // console.log("this. dragstartLeft is", this.startLeft);
...
, function(e, t, n) {
    ...
    e.exports = function(e, t, n) {
        var i = t.protocol
          ...
          , d = j(r || l.apiServer || ["c.dun.163.com", "c.dun.163yun.com"])
          , y = o({
            timeout: f,
            disableRetry: !0
        })
        ...
        var w = function() {
          ...
          , T = i + "://only-d-" + v(32) + "-" + (new Date).valueOf() + ".nstool.netease.com/ip.js";
        return p.script({
            url: T,
            timeout: f,
