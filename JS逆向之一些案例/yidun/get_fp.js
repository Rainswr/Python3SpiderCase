...
var ee = [l[42], l[43], l[44], l[45], l[46], u[0], u[1], u[3], u[5], u[6], u[50], u[52], u[54], u[56], u[58], u[59]]
...
// 获取fp参数，这里host和canvas_w对于不同网站要修改
function _fp(){
    host = "dl.reg.163.com";
    canvas_w = ["34597598435736", "25378314584639"] ;
    return W();
}
// 获取callback
function _callback() {
